# Movie-Recommendation-and-Review-Website
...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/CrAzYJOKR/Movie-Recommendation-and-Review-Website/requirements.txt) file with the command `pip install -r requirements.txt`.
